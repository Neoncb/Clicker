...
public class ClickerMain {
	...
	public void createFont(){
		...
		counterLabel = new JLabel(clickerCounter + "Clicks");		//erstellt die Schrift anzeige
		...
		public void setTimer()  {
			...
			public void actionPerformed(ActionEvent e){
				...
				clickerCounter++;
				counterLabel.setText(clickerCounter + "Clicks");	
			}	
